...
//        System.out.println("------");
    ...
    private static List<List<Integer>> genJensenPointsPartition(int tspSize, int pointsCount) {
...
//                genJahnePointsPartition(tspSize);
                genJensenPointsPartition(tspSize, 10);
        PrintWriter pw = null;
        ...
        for (int i = 0; i < runs; i++) {
            ...
            if (pw == null) {
                pw = new PrintWriter("../TSP/multi/" + instance + "JensenRandom");
            }
            ...
            for (int g = 0; g < generations; ++g) {
                if (g % iterPerHelper == 0) {
                    algo.changeCriterion(g / iterPerHelper);
                }
                algo.computeValues();
            }
