 ...
 */
public class PrioritizedSweepingConfiguration extends LearnConfiguration {
    ...
    /**
     * Constructs {@link PrioritizedSweepingConfiguration} with the specified {@link java.util.Properties}.
     * @param properties the specified properties
     */
    public PrioritizedSweepingConfiguration(Properties properties) {
        super(properties);
    ...
    /**
     * Constructs {@link PrioritizedSweepingConfiguration} with the specified parameters
     *
     ...
     */
    public PrioritizedSweepingConfiguration(int steps, double crossover,
    ...
    public Agent<String, Integer> createAgent() {
        return new PrioritizedSweepingAgent<>(probability, discount, k, strategy);
    }
    ...
    public boolean equals(Object obj) {
        ...
        PrioritizedSweepingConfiguration other = (PrioritizedSweepingConfiguration) obj;
    ...
    public <A, R> R accept(@NotNull ConfigurationVisitor<A, R> visitor, @NotNull A argument) {
        return visitor.visitPrioritizedSweepingConfiguration(this, argument);
    }
}
